# Testar as bibliotecas de pre commit
...
print(
    f"= Código == Nome do Candidato == Votos =\n"
...
print(
    f"Votos nulos {nulos} , votos brancos {brancos}  ,  votos válidos {validos} , votos totais {total}"
)

print(
    f"==== Tabela do Vencedor ====                            \n"
...
print(
    f"==== Percentual de votos brancos em relação ao total ====\n"
    + f"                    {percentualB}%                       \n"
)

print(
    f"==== Percentual de votos nulos em relação ao total ====\n"
    + f"                    {percentualN}%                     \n"
)
